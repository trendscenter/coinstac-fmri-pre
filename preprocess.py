...
# changed the trait to Float, which can be coerced to Integer, but not the reverse. 
# This allows the entry of a reference time point. - HP, Dec 1, 2020

#    ref_slice = traits.Int(
    ref_slice=trains.Float(
        field='refslice',
